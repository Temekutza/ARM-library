...
namespace ARM_library
{
    public partial class IssueWindow : Window
    {
        ...
        public IssueWindow(DataAccess db, Issue issue) : this(db)
        {
            ...
            HeaderText.Text = "Редактирование выдачи";
            OkButton.Content = "Сохранить";

            BooksBox.SelectedValue = issue.BookId;
            ReadersBox.SelectedValue = issue.ReaderId;
            EmployeesBox.SelectedValue = issue.EmployeeId;
            IssueDatePicker.SelectedDate = issue.IssueDate;
        }
